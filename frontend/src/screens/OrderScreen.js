          ...
          <ul>
            <li>
              <div className="card card-body">
                <h2>Доставка</h2>
                <p>
                  <strong>Ім'я:</strong> {order.shippingAddress.fullName} <br />
                  ...
                  {order.orderItems.map((item) => (
                    <li key={item.product}>
                      <div className="row">
                        ...
                        <div>
                          {item.qty} x Грн{item.price} =  Грн{item.qty * item.price}
                        </div>
                      </div>
                    </li>
                  ))}
          ...
          <div className="card card-body">
            <ul>
              ...
              <li>
                <div className="row">
                  <div>Товари</div>
                  <div>Грн{order.itemsPrice.toFixed(2)}</div>
                </div>
              </li>
              <li>
                <div className="row">
                  <div>Доставка</div>
                  <div>Грн{order.shippingPrice.toFixed(2)}</div>
                </div>
              </li>
              <li>
                <div className="row">
                  ...
                  <div>
                    <strong>Грн{order.totalPrice.toFixed(2)}</strong>
                  </div>
                </div>
              </li>
              {!order.isPaid && (
